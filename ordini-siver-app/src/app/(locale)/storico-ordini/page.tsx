  ...
  return (
    <main className="min-h-screen bg-slate-100 px-3 py-4 sm:px-5 lg:px-8">
      <div className="mx-auto max-w-7xl space-y-4">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="grid grid-cols-2 gap-2 sm:flex">
              ...
              <button
                ...
                className="inline-flex h-12 items-center justify-center gap-2 rounded-2xl bg-slate-900 px-5 text-sm font-bold text-white"
              >
        ...
        {loading ? (
          <section className="rounded-3xl border border-slate-200 bg-white p-8 text-center text-sm font-bold text-slate-500 shadow-sm">
                  ...
                  <div className="flex flex-col gap-3 p-4 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    >
                      <div className="flex flex-wrap items-center gap-2">
                        <span className="inline-flex items-center gap-2 rounded-2xl bg-blue-50 px-3 py-2 text-sm font-bold text-blue-700">
                          <CalendarDays className="h-4 w-4" />
                          {dataIt(gruppo.settimana)}
                        </span>

                        <span className="inline-flex items-center gap-2 rounded-2xl bg-slate-100 px-3 py-2 text-sm font-bold text-slate-700">
                      ...
                      <div className="mt-3 grid grid-cols-2 gap-2 sm:flex sm:flex-wrap">
                        <span className="rounded-2xl bg-slate-50 px-3 py-2 text-sm font-bold text-slate-800">
                          {gruppo.prodotti.length} prodotti
                        </span>

                        <span className="rounded-2xl bg-green-50 px-3 py-2 text-sm font-bold text-green-700">
                          {totale} pezzi
                        </span>
                      </div>
                    </button>
                    ...
                    <button
                      type="button"
                      onClick={() => setGruppoAperto(aperto ? null : gruppo.id)}
                      className="h-12 rounded-2xl bg-slate-950 px-5 text-sm font-bold text-white"
                    >
                      {aperto ? "Chiudi" : "Apri"}
                    </button>
                  </div>
